        ...
        <div className="grid px-8 pt-24 xl:grid-cols-2 sm:grid-rows-2 ">
          <div className="w-full mt-24 select-none proImage">
            <img
              ...
              className="px-10 xl:fixed xl:h-4/5"
              alt="product"
            />
          </div>
          ...
          <div className="container mx-auto mt-24">
            ...
            <div className="grid items-center gap-5 mt-8 text-center sm:grid-cols-2 xs:grid-rows-2">
              <button
                disabled={order}
                className={`flex justify-center xs:h-11 sm:h-10 gap-3 pt-2 text-center text-white rounded-md w-50 bg-purple-medium ${
                  order && "opacity-50"
                }`}
                onClick={handleOrder}
              >
